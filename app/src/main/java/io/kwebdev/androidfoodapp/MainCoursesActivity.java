...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] dishes = {
                new Dish("Black pepper and chickpea vindaloo", "Hot vindaloo made with hot black pepper and fresh stuff", 1299),
                new Dish("Goji berry and cauliflower salad", "A crisp salad featuring fresh goji berries and cauliflowers", 999),
