...
public class StartersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] dishes = {
                ...
                new Dish("Egg and avocado urakami", "Pasta in a sauce made from free range eggs and fresh avocado", 1199),
                ...
                new Dish("Chili and aubergine dip", "A dip made from scotch bonnet chilli and fresh aubergine", 999),
                new Dish("Chickpea and chili gyoza", "Thin pastry cases stuffed with fresh chickpea and green chili", 699),
